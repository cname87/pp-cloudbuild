...
import { MemberSessionsComponent } from './member-questionaires.component';
...
describe('MemberSessionsComponent', () => {
  ...
  class Page {
    ...
    constructor(readonly fixture: ComponentFixture<MemberSessionsComponent>) {}
  }
  ...
  function createComponent() {
    /* create the fixture */
    const fixture = TestBed.createComponent(MemberSessionsComponent);
