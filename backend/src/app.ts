...
import { createModelSessions2 } from './models/src/sessions2-model';
/* controllers */
...
import { sessions2Api } from './api/sessions2-api';
/* 2nd level handlers */
...
import { sessions2Handlers } from './handlers/sessions2-handlers';
...
const createStore = (): Perform.IAppLocals => {
  return {
    ...
    models: {
      ...
      sessions2: {} as any as Perform.IModelExtended,
    },
...
const storeDatabase = async (store: {
  ...
  try {
    ...
    if (store.models?.sessions2) {
      store.models.sessions2 = {} as any as Perform.IModelExtended;
    }
